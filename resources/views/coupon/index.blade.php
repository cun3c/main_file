                            ...
                            @foreach ($coupons as $coupon)
                                <tr class="font-style">
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href="#" class="action-item" data-size="lg" data-ajax-popup="true" data-toggle="tooltip" data-original-title="{{__('Edit')}}" data-url="{{route('coupons.edit',[$coupon->id])}}" data-title="{{__('Edit Coupon')}}">
