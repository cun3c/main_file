...
@section('action-btn')
     ...
     <a href="#" class="btn btn-sm btn-white bor-radius ml-1 mb-1" data-url="{{ route('product.file.import') }}" data-ajax-popup="true" data-title="{{__('Import customer CSV file')}}">
        <i class="fa fa-file-csv"></i> {{__('Import')}}
    </a>
    <a href="{{route('product.export')}}" class="btn btn-sm btn-white bor-radius ml-1 mb-1">
        <i class="fa fa-file-excel"></i> {{__('Export')}}
    </a>

    <a href="{{ route('product.grid') }}" class="btn btn-sm btn-white bor-radius ml-1 mb-1">
        {{__('Grid View')}}
    </a>
    <a href="{{ route('product.create') }}" class="btn btn-sm btn-white btn-icon-only rounded-circle mb-1">
