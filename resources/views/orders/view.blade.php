...
@section('action-btn')
    <div class="col-auto pt-2">
        <a href="{{route('order.receipt',$order->id)}}" data-toggle="tooltip" data-title="{{__('Receipt')}}" class="btn btn-sm btn-white btn-icon rounded-pill mb-2">
        ...
        <a href="#" onclick="saveAsPDF();" data-toggle="tooltip" data-title="{{__('Print')}}" id="download-buttons" class="btn btn-sm btn-white btn-icon rounded-pill mb-2">
        ...
        <div class="btn-group" id="deliver_btn">
            <button type="button" class="btn btn-sm btn-success dropdown-toggle mb-2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
